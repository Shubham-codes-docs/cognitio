let data={ep:{desc:"COGNITIO’22 brings a unique opportunity to test your mettle in form of ELEVATOR PITCH. In this event, the participants must present their unique startup idea. Ideas can be from any sector. Overall, you must present B-PLAN for your startup. This must include Market Research, Competitor analysis, USP, Revenue model, Investments Required and Marketing Strategy. Students will be judged on above parameters. Apart from these one may include points that seem relevant to the B-PLAN.",details1:["Number of students in a team: 2","The problem statement is open to innovation."],details2:[{heading:"ROUND 1: IDEA SUBMISSION ",points:["This will be a submission round. All teams must submit their business idea in PPT format.","Maximum number of slides permitted is 10 (Exclusive of Cover Page)","Top 10 teams will advance to the next round."]},{heading:"ROUND 2: IDEA PITCHING",points:["Selected teams from Round 1 will pitch their ideas before the judges.","Time limit of the presentation is 20 minutes.","Presentation will be followed with question by the judges."]}],eh:["Abhinav Raj (8825346878)"," Rishav Raj (9525018921)"],prize:"8000",name:"Elevator Pitch",img:"./assets/imgs/events/Elevator Pitch (1).jpg"},quiriosity:{desc:"India is emerging as a world leader in the field of innovation, and new age start-ups are the fore runners of this development. This years quriosity will be on start-ups. To all the quiz geeks out there, brace yourself and be ready for your quizzing mettle to be tested. It is time to compete with the finest brains of the institute and enrich your quizzing skills. QURIOSITY provides a platform to explore the charm of science and technology. To come up as a winner, you need to possess noetic and quick thinking.",details1:["Number of students in a team: 2"],details2:[{heading:"Round 1",points:["Pen and paper based preliminary test"]},{heading:"ROUND 2",points:["6 Teams will be selected on-spot from the prelims for the final quiz competition"]}],eh:[" Nilay Kumar (7903627451)","Ankita (7654875946)"],prize:"6000",name:"QURIOSITY",img:"./assets/imgs/events/Quriosity (1).jpg"},placestation:{desc:"Do you consider yourself an all-rounder? Do you have a unique way of accomplishing goals? Do you stand out in a crowd? Come enter this corporate labyrinth, where one can live and experience the nerve-wracking placement session in a real time dynamic environment with a series of stations comprising of the comprehensive written test, expressive group discussion as you make your way through the maze to the final round which is the personal interview. It’s an all round competitive event with a motive to guide the students about campus placements and at the same time select the best. So if you think you’ve got what it takes to make a mark, then do come and be a part of this grand event",details2:[{heading:"Round 1",points:["Written Test involving aptitude, logical reasoning and technical questions. (Core and Analytics)","•\tWritten Test involving aptitude, logical reasoning and coding questions (SDE)"]},{heading:"Round 2",points:["Group Discussion on practical and abstract topics (Core)","Personal Interview - Technical (Analytics and SDE)"]},{heading:"Round 3",points:["Personal Interview – Technical and HR (Core)","Personal Interview – HR (Analytics and SDE)"]}],eh:["Divya Chitransh(analytics)(8102222514)","Adarsh Singh(analytics):(9113349029)","Ragini Tejaswini(core):(8789696504)","Ritik Sharma(core):(8302433933)","Payal  Kumari(core):(9334012252)","Rishi Raj Singh(SDE):(6291426696)","Surjit Kumar(SDE):(7070308838)"],prize:"4500",name:"PLACE STATION",img:"./assets/imgs/events/PLACE STATION (1).png"},conundrum:{desc:"With the advent of Make in India, industries are transforming to a new generation. This advancement demands the engineers to showcase their skills and prove their mettle. Deep insights of engineering concepts/principles create an incision on our mind. The CONUNDRUM deals with understanding of core mechanical and manufacturing discipline with primary focus on expertise in problem solving, technical terms and ability to explain what you perceive. Let your grey cells encounter this mechanical CONUNDRUM",details1:["Students will participate individually.","The year and class of study of students will be taken into consideration."],details2:[{heading:"Round 1",points:["MCQs, MSQs and Subjective questions to check the engineering aptitude and critical thinking of the participants on core subjects"]},{heading:"Round 2",points:["Personal Interview (Technical)."]}],eh:["Ankit Kumar (8340292611)","Rohit Kumar(7488159101)"],prize:"4500",name:"CONUNDRUM",img:"./assets/imgs/events/PRIZES WORTH ₹.png"},cansys:{desc:"Design skills leads to augmentation of visualization and multi-dimension quality check of models supported by detailed analysis reports. Designing and analysis of structural and mechanical components gives a fair idea of feasibility of dimension and geometry for the optimum operation output of the model. This event deals with modeling and simulation of part body in CATIA/Solidworks backed by its analysis using ANSYS.",details1:["Number of students in a team: 2","Teams must bring their own laptops with chargers and extension cords."],details2:[{heading:"Round 1",points:["Teams must bring their own laptops with chargers and extension cords."]},{heading:"Round 2",points:["3-D part modelling and assembling in CATIA/Solidworks and analysis of designed model in ANSYS."]}],eh:["Sidharth Srivastava (8009878844)","Rohit Kumar(9709804111)"],prize:"5500",name:"CANSYS",img:""},assemblage:{desc:"Strength of mechanical models and engineering structures is an important area of study and experimentation. Concept and principles dealing with truss systems, beam loadings, stress-strain calculation and representation are imperative for evaluating the failure point of structures. Also, the knowledge of material science and vibration is essential to understand the mechanical behaviors and dynamics of system under consideration. This event deals with fabrication of a bridge model and its strength testing using varied type of loads.",details1:["Number of students in a team: 3","The team has to construct a bridge model","Required materials will be provided on-spot","The structure will be tested under loads of different nature and value and corresponding points will be awarded"],details2:[{heading:"Round 1",points:["Written test on related concepts"]},{heading:"Round 2",points:["Conceptual Design submission, Bridge Model construction, Strength Testing."]}],eh:["Ranjit Kumar Yadav(7061340811)","Sumit Kumar Singh (9576488785)"],prize:"6000",name:"ASSEMBLAGE",img:"./assets/imgs/events/ASSEMBLAGE (1).png"},dictumSymposium:{desc:" Greatest quality of a leader is wisdom of opinion and way of expression. COGNITIO ’22 brings you the opportunity to get into the war of words. Buckle up, for this is the event you craved for. Let your larynx vibrate and your words echo the whole house. DICTUM SYMPOSIUM brings all of you the experience of speaking as a leader. The event deals with expression of opinion/defending your stand on corporate issues by highlighting its social, economic, environmental and technical impacts.",details1:[" Number of students in a team: 2"],details2:[{heading:"Round 1",points:["Abstract submission describing your views on one of the prescribed topics"]},{heading:"Round 2",points:["Extempore- Topics will be provided on spot and the team members have to present their views on the same."]},{heading:"Round 3",points:["Debate- Topics will be provided beforehand. 2 teams have to debate with each other with the members of each team speaking alternatively"]}],eh:["Arsalan Khan (8102104079)","Annanya Singh(8840603244)","Srishti(6207173557)"],prize:"4500",name:"DICTUM SYMPOSIUM",img:"./assets/imgs/events/Dictum Symposium (1).jpg"},battleofbureaucrats:{desc:"  Bureaucracy is the permanent Executive branch of the Republic of India. Civil Servants in India are the unsung heroes of Indian Federal System from Secretaries in Govt. Of India to the betwixt amidst the citizens and the government.  And thus, rightly quoted as the backbone of administrative machinery in the country. This event goes for a check over the proficiency of a particular and the qualities requisite to etch herself/ himself as bureaucrats in the Steel Frame of the Nation.",details1:["Students need to participate individually"],details2:[{heading:"Round 1",points:["Pen paper based objective preliminary test"]},{heading:"Round 2",points:["Pen paper based descriptive writing on current social and geo-political issues"]},{heading:"Round 3",points:["Personality Test. Note: The entire event will comprise of subjects like General Studies, General Science and Current Affairs. The scores of all THREE rounds will be taken into consideration for finalizing the result."]}],eh:["Pranjal (9507853894)","Pratik Saurav(6200178288)"],prize:"4500",name:"Battle of Bureaucrats",img:"./assets/imgs/events/BATTLE OF BUREAUCRATS (1).png"},radiation:{desc:"Mechanical engineering deals with making of machines that makes our life easier. The current era is all about creating technology that are highly efficient in solving our problems and are also environment friendly. Intensified theoretical study followed by feasibility analysis on practical grounds is essential to come up with appropriate suggestions and solutions for complex issues. The event deals with study of prescribed topics and communication of the ideas to the judging panel through Research Paper presentation. ",details1:["Number of students in a team: 2","Teams have to choose a particular topic from the list of topics and elaborate how that topic is going to make our lives easier.","A research paper template will be provided to the students for round 2"],details2:[{heading:"Round 1",points:["Abstract submission describing your study on one of the prescribed topics. Word limit for the same is 200- 250 words. Strictly adhere to the word limit. Abstract should comprise of the following details: Team name, Team members’ name, Institute name (school name in case of school students) & roll no. "]},{heading:"Round 2",points:["Selected students will have to give research paper presentation on their topic. "]}],eh:["Mohit Kumar Sharma (8986744346)","Gullipalli Jahnavi  (8331092465)","Shruti (8102371772)"],prize:"6000",name:"RADIATION",img:"./assets/imgs/events/Radiation (1).png"},sas:{desc:"Propulsion systems are highly powerful driving technologies enabling the physical essence of distant places. The event deals with water propulsion system in rocket technology resulting in a working prototype showcasing the application of physical concepts. Put all your concepts of kinematics, aerodynamics & hydraulics to build a Water Rocket that covers  the maximum range. ",details1:["Number of students in a team: 3","Materials required to build Water Rocket will have to be brought by participants.","The team members will have to launch their Water Rocket themselves under the supervision of the event coordinators.","The participants will get three chances to launch their model.","The maximum range covered out of the three will be taken for consideration."],details2:[{heading:"Round 1",points:["Written Test involving related physical concepts.  "]},{heading:"Round 2",points:["Written Test involving related physical concepts. "]}],eh:["      Prince Kumar (7543033691)","Shilpi Jain(9584038248)","Rituraj Mishra(9955304635)"],prize:"6000",name:"SHOOT at SIGHT",img:"./assets/imgs/events/SHOOT AT SIGHT (1).jpg"},os:{desc:"Cognitio’22 isn’t just limited to technical and managerial events. It also promotes the cultural aspect of a student’s life. Open Stage will ensure that none of your expectations goes unfulfilled. Be ready to be mesmerized by the performances of your batchmates. The stage is all yours!  ",details1:["Students can participate either individually or as a team.","Students can show any kind of talent like singing, dancing, shayari, rapping, etc.","Maximum time allotted for each performance is 5 minutes.","Winners will be decided based on judges’ scores and audience votes.","The event will only be of one round."],eh:["Prasoon Jha (8340622615)","  Aniket Mishra (8603025125)"],prize:"4500",name:"OPEN STAGE",img:"./assets/imgs/events/OPEN STAGE (1).png"}};const urlSearchParams=new URLSearchParams(window.location.search),params=Object.fromEntries(urlSearchParams.entries()),branding=(console.log(params),document.querySelector(".tm-brand-name")),para=document.querySelector(".tm-hero-text"),eventHeads=document.querySelector(".event-heads"),rulesHeading=document.querySelector(".rules"),rules1=document.querySelector(".rules-sec-1"),rules2=document.querySelector(".rules-sec-2"),eventImage=document.querySelector(".event-image"),hydrateData=e=>{branding.textContent=e.name,eventImage.src=e.img,para.textContent=e.desc,e.details1&&e.details1.forEach(e=>{var t=document.createElement("li");t.textContent=e,rules1.appendChild(t)}),e.details2&&e.details2.forEach(e=>{var t=document.createElement("li");let a=document.createElement("ul");t.textContent=e.heading,e.points.forEach(e=>{var t=document.createElement("li");t.textContent=e,a.appendChild(t)}),t.appendChild(a),rules2.appendChild(t)}),e.eh.forEach(e=>{var t=document.createElement("li");t.textContent=e,eventHeads.appendChild(t)})};switch(params.q){case"pitch":hydrateData(data.ep);break;case"quriosity":hydrateData(data.quiriosity);break;case"assemblage":hydrateData(data.assemblage);break;case"radiation":hydrateData(data.radiation);break;case"placestation":hydrateData(data.placestation);break;case"conundrum":hydrateData(data.conundrum);break;case"cansys":hydrateData(data.cansys);break;case"battleofbureaucrats":hydrateData(data.battleofbureaucrats);break;case"dictumsymposium":hydrateData(data.dictumSymposium);break;case"shootatsight":hydrateData(data.sas);break;case"openstage":hydrateData(data.os)}
